	...
	<header class="am-topbar">
		...
		<div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse">
			<ul class="am-nav am-nav-pills am-topbar-nav">
				<li class="am-active"><a href="#">胶囊内容</a></li>
			</ul>
		</div>
	</header>
		...
		<div class="am-u-md-8">
			...
			<article class="blog-main">
				...
				<h4 class="am-article-meta blog-meta">
					埋藏者： <a href="">神父</a> <br> 埋藏期 ：<a href="">1994/06/17 ——
						2014/06/17神父</a>
				</h4>

				<div class="am-g blog-content">
					<div class="am-u-lg-7">
						<p>什么是时间?圣奥古斯丁对这个问题的回答广为人知，他说，没有人问他时，他知道，一旦要加以解释，他就不知道了。</p>
						<p>这个难题部分来自于问题的复杂性质。每个人都会从一个不同的视角来思考“什么是时间”这个问题。我们会问，时间是线性的还是循环的，时间是否是无止境的，在时间中旅行是否可能，对时间流逝的体验是如何产生的，我们体内的生物钟是如何调控的，以及我们的语言如何把握我们的存在的时间性。</p>
						<p>在本书中，九位杰出的研究者探讨了在其各自领域中的研究，对时间本质的问题产生了怎样的冲击。这些领域包括从艺术人文学科到自然科学的整个范围，反映出这个主题真正的跨学科性质。</p>
					</div>
					<div class="am-u-lg-5">
						<p>
							<img
								src="http://img1.cache.netease.com/catchpic/1/12/12F8B73C87B2C139E38B2BFD5EB084AD.jpg">
						</p>
					</div>
				</div>
			</article>
