...
public class TextHandler implements WxMpMessageHandler {
	...
	public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage, Map<String, Object> context, WxMpService wxMpService,
		...
		mpXmlOutMessage = WxMpXmlOutMessage.TEXT().fromUser(wxMessage.getToUserName())
				.toUser(wxMessage.getFromUserName()).content("Message Test").fromUser(wxMessage.getToUserName())
				.toUser(wxMessage.getFromUserName()).build();

		System.out.println("TextHandler  WxMpXmlOutMessage:" + mpXmlOutMessage.toString());
